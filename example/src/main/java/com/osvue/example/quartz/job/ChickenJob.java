package com.osvue.example.quartz.job;
...
public class ChickenJob implements Job, Serializable {
  ...
  public void test1() {
    System.out.println(LocalDateTime.now().toString()+"测试方法1");
  }

  public void test2() {
    System.out.println(LocalDateTime.now().toString()+"测试方法2"+LocalDateTime.now().toString());
  }

  public void test3() {
    System.out.println("测试方法3"+LocalDateTime.now().toString());
  }
}
