...
/**
 * Created by   
 * restTemplateUtils 高性能请求http https 时间单位 毫秒
 */
...
class RestTest {
  /**
   *
   * get path路径参数 头在真实项目是必须的基本都要涉及SDK安全认证
   */
  ...
  public void test() {
    ...
    ResponseEntity<String> entity = RestTemplateUtil.get(url, headers, String.class, 123, "Jack");
